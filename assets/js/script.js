 ...
 * snd sfter the user's answer has been processed
 */
...
function checkAnswer(){
    ...
    if (isCorrect) {
        ...
        alert (`Aww.... you answered ${userAnswer}. The correct answer was ${calculateAnswer[0]}!`);
    }
...
function calculateCorrectAnswer() {
    ...
    if (operator === "+") {
        ...
        throw `Unimolemented operator ${operator}. Aborting!`;
    }
}
